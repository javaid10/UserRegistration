...
public enum ErrorCode {
	ERR_60000(60000, " Success"), ERR_61002(61002, " Record Not Inserted"), ERR_61004(61004, " Record Not Found"),
	...
	ERR_66002(66002, "OTP has sent to provided Mobile Number"), ERR_66003(66003, "Error Occured while sending OTP"),
	ERR_66004(66004, "Error Occured while registration of Mobile Number"),

	ERR_66005(66005, "Mobile Number is required"), ERR_66006(66006, "Email is required"),
	ERR_66007(66007, "Password is required"),

	ERR_66008(66008, "ID is required"), ERR_66009(66009, "Date of Birth is required"),
	ERR_660010(660010, "Loan Purpose is required"), ERR_660011(660011, "IBAN is required"),
	ERR_660012(660012,
			"National ID you have provided is already registered, please Login with Registered Mobile Number"),
	...
	ERR_660024(660024, "ChargeCode is require"), ERR_660025(660025, "Product is require"),
	ERR_660026(660026, "Age is require"), ERR_660027(660027, "Error Occurred while performing Knockout stage"),
	// Error Occured while registration of Mobile Number
	ERR_660028(660028, "Knockout Failed, Application has Declined"), ERR_660029(660029, "Knockout Success"),
	ERR_660030(660030, "Application Successfully created. Application ID: "),
	ERR_660031(660031, "Product ID is require"), ERR_660032(660032, "National ID/Iqama is required"),
	ERR_660033(660033, "Employement Status is not Active"),
	ERR_660034(660034, "Provided Mobile Number is not Registered"),

	ERR_660035(660035, "Loan Amount is required"), ERR_660036(660036, "Tenor is required"),
	ERR_660037(660037, "Monthly Repayment is required"), ERR_660038(660038, "Approx is required"),
	ERR_660040(660040, "Provided National ID is not Found in the System"),
	ERR_660041(660041, "National Address Check Failed"), ERR_660042(660042, "ApplicationID is required"),
